# Contributing to AumAI Nanoagent
...
### Setup
```bash
git clone https://github.com/aumai/aumai-nanoagent.git
cd aumai-nanoagent
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-nanoagent/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-nanoagent/discussions)
